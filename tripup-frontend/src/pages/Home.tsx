...
export default function Home() {
  ...
  return (
    <>
      <Layout>
        ...
        <div className=" py-40 px-10 md:px-20 sm:py-50 bg-center  bg-cover bg-[url('/src/assets/plane.jpeg')]" >
          ...
          <div className='flex justify-center'>
            {user ?
              (<button onClick={() => navigate("/mytrip")} className="inline-flex items-center px-5 py-3 text-base font-medium text-center text-gray-800 bg-[#98DB2E] rounded-lg hover:bg-[#99db2eca] " >
                Start Planning
                <svg className="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                  <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                </svg>
      ...
      <Modal show={openModal} className='bg-black' size="sm" position="center" onClose={() => setOpenModal(false)} popup dismissible >
