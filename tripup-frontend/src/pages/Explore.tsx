...
export default function Explore() {
    ...
    return (
        <>
            ...
            <Modal show={loginModalOpen} className='bg-black' size="sm" position="center" onClose={() => setLoginModalOpen(false)} popup dismissible>
                <Modal.Header ></Modal.Header>
                <Modal.Body>
                    <h1 className='text-center mb-10 text-2xl font-medium text-black'>Please Sign In</h1>
