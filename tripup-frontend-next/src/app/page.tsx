...
export default function Home() {
  ...
  return (
    <>
      <NavBar />
      <div className="py-52 px-10 md:px-20 sm:py-50 bg-center bg-cover bg-[url('/img/hero-pattern.svg')]" >
        ...
        <Link href="./Discover" className="inline-flex items-center px-5 py-3 text-base font-medium text-center text-gray-800 bg-[#98DB2E] rounded-lg hover:bg-[#99db2eca] " >
          Discover
